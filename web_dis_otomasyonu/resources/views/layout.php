    ...
    <div class="app-container">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="nav-section">
                ...
                <a href="<?= url('/') ?>" class="nav-item <?= strpos($currentUri, '/profile') === false ? 'active' : '' ?>">
                    <i class="ri-calendar-event-fill"></i>
                    <span><?= __('menu.dashboard') ?></span>
                </a>
                <a href="<?= url('/profile') ?>" class="nav-item <?= strpos($currentUri, '/profile') !== false ? 'active' : '' ?>">
            ...
            <div class="nav-bottom">
                ...
                <div class="settings-row">
                    ...
                    ?>
                    <a href="<?= url('/lang') ?>?l=<?= $targetLang ?>" class="icon-btn tooltip" data-tooltip="<?= $langLabel ?>">
                        <?= ($curLang == 'tr') ? '🇬🇧' : '🇹🇷' ?>
                    ...
                    <a href="<?= url('/logout') ?>" class="icon-btn tooltip" data-tooltip="<?= __('menu.logout') ?>" style="color:var(--danger-500);">
