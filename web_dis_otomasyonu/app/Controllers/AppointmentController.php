...
class AppointmentController {
    ...
    public function getTakenSlots() {
        ...
        try {
            ...
            // Get taken slots from Service (PostgreSQL) instead of direct SQLite
            $taken = $this->appointmentService->getTakenSlots($_GET['doctor_id'], $_GET['date']);
    ...
    public function cancel() {
        ...
        try {
            ...
            $result = $this->appointmentService->cancelAppointment($input['id'], $userId);
            
            if (!$result) {
                throw new \Exception('Randevu iptal edilemedi veya zaten iptal edilmiş.');
            }
